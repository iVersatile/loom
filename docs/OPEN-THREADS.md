...
## T37 — Target Env: devcontainer `import` (charter scenario 3 / Phase 4, ADR-0003)   🟢 STAGE-1 SHIPPED 2026-06-21 — clause #233 (ALLOW_SPEC_CHANGE) + build #234 (`FR-IMPORT-001/002/003`); opens Target Env (was 0 FRs). NEXT: AI enrich skill (Stage-3) · features/commands mapping (needs schema) · windows validation (hardware) · cloud sandbox (Phase 5)
