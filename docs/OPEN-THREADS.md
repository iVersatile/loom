...
## T33 — author-as-ephemeral-fleet / advisor-as-supervisor (1 advisor ↔ N headless authors)   🟡 open — ADR-0025 proposed; ad-hoc author /confer → REBUT (4 objections) → revised R1 (binds independence/red-team, gates 1:N on hardened spawn-ledger, dead-worker recovery via ADR-0020, lands proposal on main) → RE-CONFER pending; acceptance = human after pass
