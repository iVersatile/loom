...
Pointers: ADR-0022 cold-floor · `scripts/cold-floor-cron` (#176) · advisor /loop git-controller sidecar (proto-supervisor) · T27 (wake/observability) · memory host-action-delta-op-triage · couples to T18 (who runs/declares the supervising layer).
