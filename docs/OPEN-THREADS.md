...
## T36 — The Run: onboarding/installer slices (charter scenarios 1–2)   🟢 scenario-1 SHIPPED 2026-06-20 (`loom start` #227) · 🟢 scenario-2 CONTINUITY half SHIPPED 2026-06-20 (`detect --emit-playbook` #229) — remaining: scenario-2 credential-MOVE (`detect --migrate`)
