...
## T33 — author-as-ephemeral-fleet / advisor-as-supervisor (1 advisor ↔ N headless authors)   🟡 open — ADR-0025 proposed (docs/patches/0025), /confer run (advisor self-steelman → human), awaiting human acceptance
