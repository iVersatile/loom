...
| T10 non-root user / parameterized $HOME | — | hardening; one of three full-auto re-eval gates | loom-author | design + PR 1 merged 2026-06-12 (#122; T10 thread 🟢 full design + containerHome single-owner fix). NEXT: PR 2 (spec `user:` clause, human-authorized via adv-048) is WAITING on the advisor T10 red-team verdict (due 2026-06-13); PR 3 engine / PR 4 role-marker+doctor = draft 047 (advisor triage) | #122 |
