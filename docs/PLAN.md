...
| weekly report: /coordinate WEEKLY MODE (docs/reports/YYYY-WW.md; confidence lens, dependency graph, coverage map, EXPERIMENTS section; absorbs P8) | — | human-decided P12 2026-06-11; first issue 2026-06-18 = trial day-7 verdict report | loom-author | in review — branch feat/coordinate-weekly-mode (mode built per draft 015 + amendment; first issue runs 2026-06-18 under the hat); awaits host push (T18) | — |
