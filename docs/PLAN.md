...
| /specmap project skill (regenerate docs/spec-map.md: FR-registry + OPEN-THREADS gather, model edge-annotation; report = the map PR) | spec-map doc merged | spec/thread shape visible on demand; map stays truthful | loom-author | queued | — |
