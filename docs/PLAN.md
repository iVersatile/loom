...
| T16 engine work (`harness:` schema + materialize handlers) | ADR-0015 ✓, T7 fix ✓, `harness:` clause accepted ✓ (#53) | T12 criterion 4 | loom-author | in review — PR 1 #86 + PR 2 #87 merged 2026-06-12; PR 3 built: branch feat/t16-gitconfig-doctor (gitconfig dotfile ref + base noreply identity + doctor host:gitconfig), stacked on the T4→R1 chain | #86, #87 |
