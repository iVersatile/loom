...
| T16 engine work (`harness:` schema + materialize handlers) | ADR-0015 ✓, T7 fix ✓, `harness:` clause accepted ✓ (#53) | T12 criterion 4 | loom-author | PR 1 in review (schema+merge+validate+materialize, FR-BUILD-009/FR-SCHEMA-008); PR 2 = base playbook wire-up + verify flips; PR 3 = gitconfig+doctor | feat/t16-harness-schema |
