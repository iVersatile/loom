...
**Date:** 2026-06-10   **Status:** Proposed (agent-drafted per RULES §5/C3; records decisions made with the human in T9 — the SPEC-verbs clause itself is human-authored and is NOT contained here; acceptance = PR merge)
