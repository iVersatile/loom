...
// debian:bookworm-slim ships neither a current Go nor gitleaks nor golangci-lint,
// so those are not apt: Go comes from the official tarball,
// gitleaks/gopls/golangci-lint via `go install`.
